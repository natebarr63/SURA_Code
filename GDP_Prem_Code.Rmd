...
IPO_Gross_GDP_lm <- lm(GDP ~ IPO_Gross, data = combined_data_IPO_Gross)
...
#Gross IPO and GNP
IPO_Gross_Gross.national.product_lm <- lm(Gross.national.product ~ IPO_Gross, data = combined_data_IPO_Gross)
...
#Gross IPO and Nondurable goods
IPO_Gross_Nondurable.goods_lm <- lm(Nondurable.goods ~ IPO_Gross, data = combined_data_IPO_Gross)
...
#Gross IPO and Gross private domestic investment
IPO_Gross_Gross.private.domestic.investment_lm <- lm(Gross.private.domestic.investment ~ IPO_Gross, data = combined_data_IPO_Gross)
...
Personal.consumption.expenditures ~ IPO_Gross, data = combined_data_IPO_Gross)
...
DPRatio_GDP_lm <- lm(GDP ~ DPRatio, data = combined_data_DPRatio)
...
#DPRatio and GNP
DPRatio_Gross.national.product_lm <- lm(Gross.national.product ~ DPRatio, data = combined_data_DPRatio)
...
#DPRatio and Nondurable goods
DPRatio_Nondurable.goods_lm <- lm(Nondurable.goods ~ DPRatio, data = combined_data_DPRatio)
...
#DPRatio and Gross private domestic investment
DPRatio_Gross.private.domestic.investment_lm <- lm(Gross.private.domestic.investment ~ DPRatio, data = combined_data_DPRatio)
...
Personal.consumption.expenditures ~ DPRatio, data = combined_data_DPRatio)
...
EPBound_GDP_lm <- lm(GDP ~ EPBound, data = combined_data_EPBound)
...
#EPBound and GNP
EPBound_Gross.national.product_lm <- lm(Gross.national.product ~ EPBound, data = combined_data_EPBound)
...
#EPBound and Nondurable goods
EPBound_Nondurable.goods_lm <- lm(Nondurable.goods ~ EPBound, data = combined_data_EPBound)
...
#EPBound and Gross private domestic investment
EPBound_Gross.private.domestic.investment_lm <- lm(Gross.private.domestic.investment ~ EPBound, data = combined_data_EPBound)
...
Personal.consumption.expenditures ~ EPBound, data = combined_data_EPBound)
...
#ggplot(data=combined_data_IPO_Gross, aes(x= Year, y= IPO_Gross, group= recession)) +
