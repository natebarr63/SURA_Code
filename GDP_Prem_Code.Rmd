...
result <- c()
m = 1
while (m < length(quart)) {
  if (quart[i] ==  "Q1"){
    x <- paste('01','01', yr[m], sep = "/")
    result <- c(as.Date(x, format="%m/%d/%Y"), m)
    
  }
  else if (quart[i] ==  "Q2"){
    x <- paste('04','01', yr[m], sep = "/")
    result <- c(as.Date(x, format="%m/%d/%Y"), m)
  }
  else if (quart[i] ==  "Q3"){
    x <- paste('07','01', yr[m], sep = "/")
    result <- c(as.Date(x, format="%m/%d/%Y"), m)
  }
  else {
    x <- paste('10','01', yr[m], sep = "/")
    result <- c(as.Date(x, format="%m/%d/%Y"), m)
  }
...
combined_data_IPO_Gross$Date = date_makers(combined_data_IPO_Gross$Year,
